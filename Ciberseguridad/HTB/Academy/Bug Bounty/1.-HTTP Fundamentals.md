...
```shell-session
k4rma83@htb[/htb]$ curl inlanefreight.com
...
```shell-session
k4rma83@htb[/htb]$ curl -O inlanefreight.com/index.html
k4rma83@htb[/htb]$ ls
index.html
```
...
```shell-session
k4rma83@htb[/htb]$ curl -s -O inlanefreight.com/index.html
```
